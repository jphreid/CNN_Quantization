...
if __name__ == '__main__':
  ...
  name_file = 'CIFAR_28ff'
  nb_epoch = 300
  
 
  lossTotal, errorTotal, errorTest= main(nb_epoch) # , H, W, W_q, gradH, gradW, gradW_q 
  ...
  filename = '../savedata/{}_epoch_{}_lr_x2.pkl'.format(name_file, nb_epoch)
  with open(filename, 'wb') as  f: 
    pickle.dump(dd, f)
